...
if($party_code==0){
	$credit_result_total=mysqli_query($con, "SELECT sum(amount) AS credit FROM records WHERE create_date BETWEEN STR_TO_DATE('$from_date','%d/%m/%Y') and STR_TO_DATE('$to_date','%d/%m/%Y') and amount_type='c' and status='d' and particular LIKE '$particular%'");
	$debit_result_total=mysqli_query($con, "SELECT sum(amount) AS debit FROM records WHERE create_date BETWEEN STR_TO_DATE('$from_date','%d/%m/%Y') and STR_TO_DATE('$to_date','%d/%m/%Y') and amount_type='d' and status='d' and particular LIKE '$particular%'");
	...
	$credit_result_total=mysqli_query($con, "SELECT sum(amount) AS credit FROM records WHERE party_id=$party_code and create_date BETWEEN STR_TO_DATE('$from_date','%d/%m/%Y') and STR_TO_DATE('$to_date','%d/%m/%Y') and amount_type='c' and status='d'");
	$debit_result_total=mysqli_query($con, "SELECT sum(amount) AS debit FROM records WHERE party_id=$party_code and create_date BETWEEN STR_TO_DATE('$from_date','%d/%m/%Y') and STR_TO_DATE('$to_date','%d/%m/%Y') and amount_type='d' and status='d'");
